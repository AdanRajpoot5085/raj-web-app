...
function Carousel() {
  ...
  return (
    <div className='w-[1440px] m-auto h-[676px] flex gap-[80px] Carousel' >
      <div className="carousel h-[452px] gap-[48px] flex justify-between">
        <button onClick={handlePrevious} className="carousel-button"><img className='m-[auto]' src='/Testimonial/Icon1.png' alt="Previous Slide Icon" /></button>
        <div className="slides-container w-[768px]">
        ...
        <button onClick={handleNext} className="carousel-button "><img className='m-[auto]' src='/Testimonial/Icon.png' alt="Next Slide Icon" /></button>
      </div>
    </div>
  );
}
